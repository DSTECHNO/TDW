...
with logo_col1:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://heatwise.eu' target='_blank'>
            <img src='https://raw.githubusercontent.com/IbrahimEthem-Ispir/Digital-Twin-of-AAU-Pilot/main/heatwise_logo.svg' 
...
with logo_col2:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://dstechs.net/' target='_blank'>
            <img src='https://raw.githubusercontent.com/IbrahimEthem-Ispir/Digital-Twin-of-AAU-Pilot/main/dstech_logo.png' 
...
if view_tab == "About":
    ...
    # AAU Building Image
    st.image(
        "https://raw.githubusercontent.com/IbrahimEthem-Ispir/Digital-Twin-of-AAU-Pilot/main/aau.png",
